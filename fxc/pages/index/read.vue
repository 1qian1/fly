<template>
  <view class="container">
    <!-- 文章内容 -->
    <view class="content" v-for="(paragraph, index) in englishParagraphs" :key="index">
      <text class="english-paragraph">{{ paragraph }}</text>
	  <br>
      <text class="chinese-paragraph">{{ chineseParagraphs[index] }}</text>
    </view>
  </view>
</template>
